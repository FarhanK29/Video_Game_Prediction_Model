...
data = [8850, 9480, 729040, 1030840, 1086940, 1088710, 1091500, 1105500, 1105510, 1113000, 1172470, 1174180, 1235140, 1237970, 1238810, 1245620, 1388590, 2096600, 2096610, 2208920, 2221920, 2231380, 2239550, 2369390]
i = 0
for appid in data:
    print (f'{i}/{len(data)}')
    i+=1
